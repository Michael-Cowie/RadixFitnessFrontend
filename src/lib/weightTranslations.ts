...
export function convertWeight(
  fromUnit: AvailableWeightUnits,
  toUnit: AvailableWeightUnits,
  weight: number,
): number {
  if (fromUnit == toUnit) {
    return weight;
 ...
 */
export function weightFromUserMeasurementSystemtoKg(
  weight: number,
 ...
 */
export function weightFromKgToUserMeasurementSystem(
  weight: number,
  userMeasurementSystem: MeasurementSystem,
): number {
