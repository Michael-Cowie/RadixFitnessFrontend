...
import { getLocalStorage, getPersistenceKey, setLocalStorage } from 'lib/statePersistence';
                        ...
                        <div className="modal-box">
                            <form>
                                ...
                                <div className='w-full flex flex-row justify-center'>
                                    <SelectableButton selected={ selected === 'Search' } displayText='Search' onClick={ () => setSelected('Search')}/>
                                    <SelectableButton selected={ selected === 'Manual' } displayText='Manual' onClick={ () => setSelected('Manual')}/>
                                </div>

                                { selected === 'Manual' ? <ManualAddFoodEntry closeModalWindow={ closeModalWindow }/> : <SearchAddFoodEntry/> }
                            </form>
                        </div>
                    </FormContainer>
            </dialog>
